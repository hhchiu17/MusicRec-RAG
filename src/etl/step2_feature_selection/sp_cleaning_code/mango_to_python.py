...
def get_latest_spotify_collection(client, db_name, prefix="spotify_data_"):
    db = client[db_name]
...
def read_mongo_data(mongopath):
    ...
    latest_collection = get_latest_spotify_collection(mongo_client, db_name)
...
#         mongopath = "C:\\Users\\student\\rag_data_clean\\sp_cleaning_code\\sp_cleaning_p2\\config_outer.ini"
